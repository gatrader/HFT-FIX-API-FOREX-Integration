...

{
  ...
  if ((char)in_FS_OFFSET[-0x30] != '\x01') {
    if ((char)in_FS_OFFSET[-0x30] == '\x02') goto LAB_001d95c1;
...
LAB_001d95c1:
                    /* WARNING: Could not recover jumptable at 0x001d95d6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&DAT_007cb8f4 + *(int *)(&DAT_007cb8f4 + (ulong)*(byte *)(param_1 + 0x15f0) * 4)))();
  return;
}
