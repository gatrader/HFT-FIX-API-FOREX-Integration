...

{
  ...
  if ((char)in_FS_OFFSET[-0x30] != '\x01') {
    if ((char)in_FS_OFFSET[-0x30] == '\x02') goto LAB_001b37eb;
...
LAB_001b37eb:
                    /* WARNING: Could not recover jumptable at 0x001b37fd. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&DAT_007cb560 + *(int *)(&DAT_007cb560 + (ulong)*(byte *)(param_1 + 0x38) * 4)))();
  return;
}
