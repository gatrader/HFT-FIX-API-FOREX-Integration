...

{
  ...
  if ((char)in_FS_OFFSET[-0x30] != '\x01') {
    if ((char)in_FS_OFFSET[-0x30] == '\x02') {
      ...
      goto joined_r0x001b5e8d;
    }
                    /* try { // try from 001b5e49 to 001b5e64 has its CatchHandler @ 001b5f04 */
...
joined_r0x001b5e8d:
  if (iVar1 == 1) {
    if ((*(long *)(param_1 + 0x18) != 0) &&
      ...
      pcVar4 = (code *)*puVar3;
      if (pcVar4 != (code *)0x0) {
                    /* try { // try from 001b5e32 to 001b5e36 has its CatchHandler @ 001b5f11 */
        (*pcVar4)(__ptr);
      }
      if (puVar3[1] != 0) {
        free(__ptr);
                    ...
                    /* try { // try from 001b5e9b to 001b5ea2 has its CatchHandler @ 001b5f26 */
    ::core::ptr::
    drop_in_place<arbitrage_bot::websocket::market_ws::run_trading_loop::__closure__::__closure__>
              (param_1 + 0x18);
  }
  memcpy((void *)(param_1 + 0x10),param_2,0x15e8);
  if ((char)in_FS_OFFSET[-0x30] != '\x01') {
    if ((char)in_FS_OFFSET[-0x30] == '\x02') {
      return;
    }
