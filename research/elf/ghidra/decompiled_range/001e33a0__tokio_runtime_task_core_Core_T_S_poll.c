...

{
  ...
  if ((char)in_FS_OFFSET[-0x30] != '\x01') {
    if ((char)in_FS_OFFSET[-0x30] == '\x02') goto LAB_001e344b;
...
LAB_001e344b:
                    /* WARNING: Could not recover jumptable at 0x001e345d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&DAT_007cb988 + *(int *)(&DAT_007cb988 + (ulong)*(byte *)(param_1 + 0x38) * 4)))();
  return;
}
