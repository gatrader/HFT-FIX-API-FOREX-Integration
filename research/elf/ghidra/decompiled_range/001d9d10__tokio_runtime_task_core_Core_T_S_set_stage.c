...

{
  ...
  if ((char)in_FS_OFFSET[-0x30] != '\x01') {
    if ((char)in_FS_OFFSET[-0x30] == '\x02') {
      ...
      goto joined_r0x001d9dcd;
    }
                    /* try { // try from 001d9d89 to 001d9da4 has its CatchHandler @ 001d9e44 */
...
joined_r0x001d9dcd:
  if (iVar1 == 1) {
    if ((*(long *)(param_1 + 0x18) != 0) &&
      ...
      pcVar4 = (code *)*puVar3;
      if (pcVar4 != (code *)0x0) {
                    /* try { // try from 001d9d72 to 001d9d76 has its CatchHandler @ 001d9e51 */
        (*pcVar4)(__ptr);
      }
      if (puVar3[1] != 0) {
        free(__ptr);
