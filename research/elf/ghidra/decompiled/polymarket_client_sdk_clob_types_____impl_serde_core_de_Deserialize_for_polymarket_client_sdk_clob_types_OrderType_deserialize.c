// polymarket_client_sdk::clob::types::_::_<impl_serde_core::de::Deserialize_for_polymarket_client_sdk::clob::types::OrderType>::deserialize
// entry = 002b4ee0


/* polymarket_client_sdk::clob::types::_::_<impl serde_core::de::Deserialize for
   polymarket_client_sdk::clob::types::OrderType>::deserialize */

void __rustcall
polymarket_client_sdk::clob::types::_::
_<impl_serde_core::de::Deserialize_for_polymarket_client_sdk::clob::types::OrderType>::deserialize
          (long *param_1)
  ...
  if (CONCAT44(uStack_4c,local_50) == -0x7ffffffffffffffc) {
    ...
    if (CONCAT44(uStack_4c,local_50) == -0x8000000000000000) {
      ...
      lVar1 = _<serde_json::error::Error_as_serde_core::de::Error>::custom
                        ("data did not match any variant of untagged enum OrderTypeMATCHEDmatchedDELAYEDdelayedUNMATCHEDunmatched"
                         ,0x39);
      param_1[1] = lVar1;
      *param_1 = -0x7ffffffffffffffc;
    }
